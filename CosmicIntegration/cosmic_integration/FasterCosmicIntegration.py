...
def find_detection_rate(path, dco_type="BBH", merger_output_filename=None, weight_column=None,
    ...
    # DELETE COMPAS GROUP AFTER 
    # mass_evolved_per_binary = COMPAS.mass_evolved_per_binary
    # n_systems = COMPAS.n_systems
    del Average_SF_mass_needed
    del sfr 
    ...
    formation_rate, merger_rate = find_formation_and_merger_rates(n_binaries, redshifts, times, time_first_SF, n_formed, dPdlogZ,
                                                                    metallicities, p_draw_metallicity, metallicitySystems,
                                                                    delayTimes, sw_weights)
    del dPdlogZ
    del metallicities
    del p_draw_metallicity
    del metallicitySystems
    del delayTimes
    del sw_weights

    faster_CI=True # faster_CI fix 
    # if faster_CI==True
    print('skipping detection rates')
...
def append_rates(path, formation_rate, merger_rate, redshifts, COMPAS, n_redshifts_detection,
